...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario2/subur/Q')
files_list = os.listdir();
print("files_list: "+str(files_list))
var = ['General-0-20190409-17:20:23-13224','General-0-20190409-17:30:27-11368','General-0-20190409-17:38:24-12664',
       'General-0-20190409-17:54:18-6584','General-0-20190409-18:21:39-4148','General-0-20190410-07:44:29-2764',
       'General-0-20190410-07:55:19-10860','General-0-20190410-08:08:01-9940','General-0-20190410-08:16:09-6140',
       'General-0-20190410-08:29:34-7060']
df = pd.DataFrame()
...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario2/subur/EC')
files_list = os.listdir();
print("files_list: "+str(files_list))
...
plt.title('Quality Components - Sub-urban Environment',fontdict=font)
