...
#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-urban.json')
#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-urban2.json')
data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-urban4.json')
print(data)
#var = 'General-0-20190408-12:16:24-8920'; #Scenario1-urban
#var = 'General-0-20190408-14:15:17-11024'; #Scenario2-urban
#var = 'General-0-20190408-15:12:25-13140'; #Scenario2-urban2
var = 'General-0-20190408-16:03:49-12612'; #Scenario2-urban3
...
#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-urban-EC.json')

#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-urban2-EC.json')
data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-urban4-EC.json')
#print(data)
#var = 'General-0-20190408-12:16:24-8920'; #Scenario1-urban
#var = 'General-0-20190408-14:15:17-11024'; #Scenario2-urban
#var = 'General-0-20190408-15:12:25-13140'; #Scenario2-urban2
#var = 'General-0-20190408-15:39:48-7844'; #Scenario-urban3
