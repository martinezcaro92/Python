...
#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario1-rural.json')
data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-rural.json')
print(data)
#var = 'General-0-20190408-12:31:30-8044'; #Scenario1-rural
