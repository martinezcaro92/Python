...
#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario1-suburban.json')
data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-suburban.json')
print(data)
#var = 'General-0-20190408-12:31:30-8044'; #Scenario1-suburban
var = 'General-0-20190408-14:32:38-7788'; #Scenario2-suburban
...
#data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario1-suburban-EC.json')
data = pd.read_json('C:/omnetpp-5.2.1/workbench/flora/simulations/results/Scenario2-suburban-EC.json')
#print(data)
var = 'General-0-20190408-12:31:30-8044'; #Scenario1-suburban
var = 'General-0-20190408-14:32:38-7788'; #Scenario2-suburban
...
plt.title('Quality Components - Sub-urban Environment')
