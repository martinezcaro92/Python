...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario1/subur/Q')
files_list = os.listdir();
print("files_list: "+str(files_list))
var = ['General-0-20190409-08:15:23-12952','General-0-20190409-08:25:20-12444','General-0-20190409-08:33:59-1356',
       'General-0-20190409-08:54:40-336','General-0-20190409-09:06:11-1108','General-0-20190409-09:18:18-2608',
       'General-0-20190409-09:28:10-10008','General-0-20190409-09:36:56-2904','General-0-20190409-09:45:29-9932',
       'General-0-20190409-09:57:30-13260']
df = pd.DataFrame()
...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario1/subur/EC')
files_list = os.listdir();
print("files_list: "+str(files_list))
