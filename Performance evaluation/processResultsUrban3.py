...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario2/urban/Q')
files_list = os.listdir();
print("files_list: "+str(files_list))
var = ['General-0-20190410-08:38:19-5008','General-0-20190410-08:46:11-7456','General-0-20190410-08:54:10-248',
       'General-0-20190410-09:04:52-6776','General-0-20190410-09:12:18-2760','General-0-20190410-09:18:53-7956',
       'General-0-20190410-09:26:14-7996','General-0-20190410-09:33:07-8176','General-0-20190410-09:39:56-5580',
       'General-0-20190411-11:47:49-7784']
df = pd.DataFrame()
...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario2/urban/EC')
files_list = os.listdir();
print("files_list: "+str(files_list))
