...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario1/urban/Q')
files_list = os.listdir();
print("files_list: "+str(files_list))
var = ['General-0-20190409-10:43:24-12244','General-0-20190409-10:53:45-11772','General-0-20190409-11:05:25-3628',
       'General-0-20190409-11:12:07-12336','General-0-20190409-11:44:26-12540','General-0-20190409-11:59:21-7480',
       'General-0-20190409-12:07:51-4460','General-0-20190409-12:38:33-11336','General-0-20190409-12:44:54-12540',
       'General-0-20190409-12:53:48-1508']
df = pd.DataFrame()
...
os.chdir('C:/omnetpp-5.2.1/workbench/flora/simulations/results/json/Scenario1/urban/EC')
files_list = os.listdir();
print("files_list: "+str(files_list))
...
plt.title('Quality Components - Urban Environment',fontdict=font)
